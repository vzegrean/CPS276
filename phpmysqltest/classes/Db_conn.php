...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'vzegrean';//this will be your WCC username
      $dbUsr = 'vzegrean';//this will be your WCC username
      $dbPass = 'fwje3r8aw5ze';//this will be the password found in the video.
